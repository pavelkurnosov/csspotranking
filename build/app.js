...
$templateCache.put("app/layout/partials/navigation.tpl.html","<aside id=\"left-panel\">\r\n\r\n    <!-- User info -->\r\n    <!--<div login-info></div>-->\r\n    <!-- end user info -->\r\n\r\n    <nav>\r\n        <!-- NOTE: Notice the gaps after each icon usage <i></i>..\r\n        Please note that these links work a bit different than\r\n        traditional href=\"\" links. See documentation for details.\r\n        -->\r\n        <ul data-smart-menu>\r\n            <li data-menu-collapse>\r\n                <a href=\"#\" title=\"My Campaigns\"><i class=\"fa fa-lg fa-fw fa-user\"></i> <span\r\n                        class=\"menu-item-parent\">Client Profile Creation</span></a>\r\n                <ul>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.profileCreation\">Client Profile Creation</a>\r\n                    </li>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.accountCreation\">CS Account Creation</a>\r\n                    </li>\r\n                </ul>\r\n            </li>\r\n            <li data-menu-collapse>\r\n                <a href=\"#\" title=\"My Campaigns\"><i class=\"fa fa-lg fa-fw fa-shopping-cart\"></i> <span\r\n                        class=\"menu-item-parent\">Billing System</span></a>\r\n                <ul>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.billingClients\">Clients</a>\r\n                    </li>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.billingDetails\">Details</a>\r\n                    </li>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.\">Accounts</a>\r\n                    </li>\r\n                    <li data-ui-sref-active=\"active\">\r\n                        <a data-ui-sref=\"app.biz.\">CRM</a>\r\n                    </li>\r\n                </ul>\r\n            </li>\r\n        </ul>\r\n\r\n        <!-- NOTE: This allows you to pull menu items from server -->\r\n        <!-- <ul data-smart-menu-items=\"/api/menu-items.json\"></ul> -->\r\n    </nav>\r\n\r\n    <span class=\"minifyme\" data-action=\"minifyMenu\" minify-menu>\r\n    <i class=\"fa fa-arrow-circle-left hit\"></i>\r\n  </span>\r\n\r\n</aside>");
...
angular.module('app.biz').controller('BillingClientsController', function ($scope, $window) {
    var vm = this;
    vm.a = 32;
});
'use strict';
...
(function () {
    ...
    angular.module('app.biz')
        .factory('BillingService', ['$http', '$q', 'ServerURL', function ($http, $q, ServerURL) {
            return {
                get: function () {
                ...
                create: function (data) {
                    var url = ServerURL + 'create_service';
                    var deferred = $q.defer();
                    $http({
                        method: 'POST',
                        url: url,
...
(function () {
    ...
    angular.module('app.biz')
        .factory('SummaryService', ['$http', '$q', 'ServerURL', function ($http, $q, ServerURL) {
            return {
                get: function () {
                    var url = ServerURL + 'sports';
                    var deferred = $q.defer();
...
angular.module('app.biz').controller('PinterestController', function () {
    var vm = this;
    vm.data1 = {
        chart: {type: 'bar', height: 140, backgroundColor: 'rgba(255, 255, 255, 0.8)'},
        credits: {enabled: false},
